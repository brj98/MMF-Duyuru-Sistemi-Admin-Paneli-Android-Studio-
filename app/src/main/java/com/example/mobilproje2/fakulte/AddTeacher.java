...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] items = new String[]{"Kategori Seç","BİLGİSAYAR MÜHENDİSLİĞİ","BİYOMEDİKAL MÜHENDİSLİĞİ","ÇEVRE MÜHENDİSLİĞİ","ELEKTRİK-ELEKTRONİK MÜHENDİSLİĞİ","GENETİK VE BİYOMÜHENDİSLİK",
                "GIDA MÜHENDİSLİĞİ","İNŞAAT MÜHENDİSLİĞİ","MAKİNE MÜHENDİSLİĞİ"};
    ...
    private void uploadData() {
        ...
        dbRef.child(uniqueKey).setValue(teacherData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(AddTeacher.this, "sus knk", Toast.LENGTH_SHORT).show();
            }
        });
